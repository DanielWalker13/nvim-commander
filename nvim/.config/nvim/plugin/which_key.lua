...
--     r = { "<cmd>Telescope oldfiles<cr>", "Open Recent File", noremap=false, buffer = 123 }, -- additional options for creating the keymap
  ...
  h = {
    ...
    h = {':lua require("harpoon.ui").nav_file(1) <CR>', 'Secect 1st buffer' },
    j = {':lua require("harpoon.ui").nav_file(2) <CR>', 'Secect 2st buffer' },
    k = {':lua require("harpoon.ui").nav_file(3) <CR>', 'Secect 3st buffer' },
    l = {':lua require("harpoon.ui").nav_file(4) <CR>', 'Secect 4st buffer' },
  },
  m = {
    name = 'General Maps',
